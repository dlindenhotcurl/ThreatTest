...
namespace Utility.ModifyRegistry
{
	...
	public class ModifyRegistry
	{
        ...
        private RegistryKey baseRegistryKey = Registry.CurrentUser; //Registry.LocalMachine;
		/// <summary>
        ...
        /// input: KeyName (string), Default (string)
        /// output: value (string) 
        /// </summary>
        public string Read(string KeyName, string Default)
        {
            string res = Read(KeyName);
            if (res == null)
                return (Default);
            else
                return res;
